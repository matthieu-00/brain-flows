  ...
  return (
    <div className="text-center py-8">
      <div className="mb-6">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2">Choose a Widget</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-64 overflow-y-auto">
        {availableWidgets.map((widgetOption) => (
          <Button
            ...
            className="p-3 h-auto flex flex-col items-center space-y-2 hover:bg-blue-50 hover:border-blue-300 transition-colors"
          >
